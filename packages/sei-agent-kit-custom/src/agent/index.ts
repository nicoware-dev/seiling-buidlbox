...
export class SeiAgentKit {
  ...
  async supplyYei(params: SupplyYeiParams): Promise<string> {
    return supplyYei(this, params);
  }

  async borrowYei(params: BorrowYeiParams): Promise<string> {
    return borrowYei(this, params);
  }

  async repayYei(params: RepayYeiParams): Promise<string> {
    return repayYei(this, params);
  }

  async withdrawYei(params: WithdrawYeiParams): Promise<string> {
    return withdrawYei(this, params);
  }

  async getYeiHealthFactor(userAddress: string): Promise<any> {
    return getYeiHealthFactor(this, userAddress);
  }

  async wrapSei(params: WrapSeiParams): Promise<string> {
    return wrapSei(this, params);
  }

  async unwrapSei(params: UnwrapSeiParams): Promise<string> {
    return unwrapSei(this, params);
  }
