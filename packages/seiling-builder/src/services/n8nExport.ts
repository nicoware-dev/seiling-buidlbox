...
export interface ContractInteractionExport {
 ...
 */
export function exportContractInteractionToN8n(interaction: ContractInteractionExport): any {
 ...
 */
export function exportDeploymentToN8n(deployment: DeploymentExport): any {
  const networkConfig = {
    testnet: 'https://evm-rpc-testnet.sei-apis.com',
    mainnet: 'https://evm-rpc.sei-apis.com',
  };
 ...
 */
export function exportWorkflowToN8n(
  interactions: ContractInteractionExport[],
  deployments: DeploymentExport[] = []
): any {
  const nodes: any[] = [];
  let xPosition = 250;
  let yPosition = 300;
 ...
 */
export function downloadWorkflow(workflow: any, filename: string = 'n8n-workflow.json') {
